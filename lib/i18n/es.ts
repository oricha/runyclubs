export const es = {
  ...
  clubsPage: {
    ...
    addClubCta: "Añade tu club",
    addClubSubtitle: "¿Organizas salidas? Publica tu club en RunClubs.es.",
  },
  collaborations: {
    label: "Partners",
    title: "Colabora con RunClubs.es",
    intro:
      "¿Eres una marca, organización o negocio relacionado con el running? Cuéntanos tu propuesta y exploramos cómo colaborar con la comunidad de corredores de RunClubs.es.",
    advertiseHint: "Si buscas espacios publicitarios o patrocinio, visita",
    advertiseLink: "Anúnciate",
    companyLabel: "Empresa",
    contactLabel: "Persona de contacto",
    emailLabel: "Email",
    areaLabel: "Área de colaboración",
    areaPlaceholder: "Patrocinio, evento, contenido…",
    messageLabel: "Mensaje",
    submit: "Enviar propuesta",
    sending: "Enviando…",
    success: "¡Gracias! Hemos recibido tu propuesta. Te contactaremos pronto.",
  ...
  advertise: {
    label: "Publicidad",
    title: "Anúnciate en RunClubs.es",
    intro:
      "Llega a corredores activos en toda España. Cuéntanos qué tipo de campaña te interesa y te enviamos información sobre formatos y disponibilidad.",
    companyLabel: "Empresa",
    contactLabel: "Persona de contacto",
    emailLabel: "Email",
    typeLabel: "Tipo de anuncio",
    typePlaceholder: "Selecciona una opción",
    budgetLabel: "Presupuesto orientativo",
    budgetPlaceholder: "Ej. 500 €/mes, 2.000 €/año…",
    messageLabel: "Mensaje",
  ...
  legal: {
    cookieBannerText:
      "Usamos cookies propias para el funcionamiento del servicio y, con tu consentimiento, cookies de analítica para mejorar la experiencia. Puedes ver más detalles en nuestra",
  ...
  errors: {
    ...
    serverErrorSubtitle:
      "Ocurrió un error inesperado. Nuestro equipo ha sido notificado. Inténtalo de nuevo en unos momentos.",
    clubNotFoundTitle: "Club no encontrado",
    clubNotFoundSubtitle:
      "Este club no existe o ha sido dado de baja. Puede que el enlace esté desactualizado.",
  ...
  billing: {
    pricingLabel: "Planes",
    pricingTitle: "Planes para clubs de running",
    ...
    faqTitle: "Preguntas frecuentes",
    faqCancelAnytime: "¿Puedo cancelar en cualquier momento?",
    faqCancelAnytimeAnswer:
      "Sí. Puedes cancelar desde el portal de facturación de Stripe. Mantendrás el acceso hasta el final del periodo pagado.",
    faqCommitment: "¿Hay permanencia?",
    faqCommitmentAnswer:
      "No. Los planes son mensuales sin compromiso de permanencia.",
    faqAfterCancel: "¿Qué pasa cuando cancelo?",
    faqAfterCancelAnswer:
      "Al finalizar el periodo de facturación, tu club vuelve al plan Gratuito. Las carreras publicadas se mantienen, pero las funciones Pro dejan de estar disponibles.",
    plans: {
      free: "Gratuito",
      pro: "Pro",
      business: "Business",
    ...
    myPlans: "Planes de tus clubs",
    myPlansEmpty: "Fundaste un club pero aún no aparece aquí. Recarga la página en unos segundos.",
  },
  common: {
    perWeek: "{n}x/semana",
